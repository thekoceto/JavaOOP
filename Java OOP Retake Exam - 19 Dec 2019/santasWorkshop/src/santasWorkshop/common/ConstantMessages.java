...
public class ConstantMessages {
    public static final String ADDED_DWARF = "Successfully added %s named %s!";

    public static final String SUCCESSFULLY_ADDED_INSTRUMENT_TO_DWARF = "Successfully added instrument with power %s to dwarf %s!";
